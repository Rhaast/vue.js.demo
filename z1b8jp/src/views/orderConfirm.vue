    ...
    <div class="checkout-order">
      ...
      <div class="item-list-wrap confirm-item-list-wrap">
        <div class="cart-item order-item">
         ...
         <!--  渲染商品列表，v-if表示只显示购物车里选中了的商品，checked=='1'表示商品选中 -->
...
<script>
  ...
  export default {
       ...
       components:{
        ...
        methods:{
          init(){
            axios.get("/users/cartList").then((response)=>{    //获取购物车选中商品列表
              ...
              this.orderTotal = this.subTotal+this.shipping-this.discount+this.tax; //实付价格等于总金额+商品运费+税费-折扣
          ...
          payMent(){            //生成商品订单
              ...
              axios.post("/users/payMent",{
                ...
                if(res.status=="0"){
                    this.$router.push({
                        path:'/orderSuccess?order='+res.result.orderId
                    })
